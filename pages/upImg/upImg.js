...
Page({
  ...
  data: {
    ...
    taxBoxFrontUrl:'',
    taxBoxBackUrl:'',
    // invoiceUrl:'https://tfile.weein.cn/group1/M00/00/09/rBIAPV46qquAZ8LsAAMH6_IHK1c062.png?filename=wxe7f96ac072265942.o6zAJs4gYMYyurA4yjczA2Iagox4.J1S8sSSINKnTe712f3bd1cee70c533d18975b508102c.png',
  ...
  // 27.客户经理提交商户电子发票信息接口
  postAddMchInfoExtendForManager(e){
    ...
    util.request(url, 'post', data, '', (res) => {
      if (res.data.success) {
        wx.navigateTo({
          url: '/pages/submit_succ/submit_succ?id='+res.data.module.id,
        })
      } else {
        that.showToast_fail(res.data.errorMsg);
      }
  ...
  onLoad: function (options) {
    ...
    // this.postAddMchInfoExtendForManager();
  },
